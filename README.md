...
- タイピングで判定されるのは英数字のみで、他はスペースキーでスキップする
- ディスプレイサイズは 992px 以上
- Windows10の最新版のChromeのみテスト
## 使い方
### ゲームのプレイ
トップページ等のパネルの「PLAY GAME」をクリックすると、画面が立ち上がりスペースキーでスタート
### ゲームの作成
1. ナビゲーション・バーの「NEW GAME」をクリック
2. New ページで、ゲームタイトルとタグとプライバシー設定を記入
3. Edit ページで、タイピングする文章とそのタイトルを記入（複数登録が可能）
## 要件定義
- Gameをプレイできる
- Gameを作成できる
- GameにStageを作成できる
